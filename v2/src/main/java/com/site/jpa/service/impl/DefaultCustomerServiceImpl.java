...
import com.site.jpa.service.abstracts.AbstractDefaultCustomerService;
...
public class DefaultCustomerServiceImpl extends AbstractDefaultCustomerService {
    ...
    @Autowired
    public DefaultCustomerServiceImpl(UserRepository repository, PasswordEncoder passwordEncoder) {
